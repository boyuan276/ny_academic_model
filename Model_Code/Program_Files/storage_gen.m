function storage = storage_gen(ees, A2F_Load_buses, GHI_Load_buses, NYC_Load_buses, LIs_Load_buses, NYCA_Load_buses, NEw_Load_buses, PJM_Load_buses,...
...
BatPCbyRgn = [
    ees.A2F_exist_cap + ees.A2F_cap,...
    ees.GHI_exist_cap + ees.GHI_cap,...
    ees.NYC_exist_cap + ees.NYC_cap,...
    ees.LIs_exist_cap + ees.LIs_cap,...
    ees.NEw_exist_cap + ees.NEw_cap,...
    ees.PJM_exist_cap + ees.PJM_cap
    ]; 
