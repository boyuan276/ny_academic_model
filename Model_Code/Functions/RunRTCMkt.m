function [CC_results, Summaryy] = RunRTCMkt(Case, d, input_params, input_vars)
%RunRTCMkt takes input parameters, input variables, a run case, and a run
%day, runs the entire RTC market model for the day, and returns summary
%values including gen revenue, operational costs, supply costs, and net
%revenue. It also outputs results for congestion congestion charges.
