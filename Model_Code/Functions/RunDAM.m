function [] = RunDAM(input_params,input_vars)
%RunDAM takes parameters, run days, cases, and resource profiles as inputs
%and returns, a
%   Detailed explanation goes here

%Define input parameters
d_start = input_params(1);
d_end = input_params(2);
case_start = input_params(3);
case_end = input_params(4);
IFlims = input_params(5);
printCurt = input_params(6);
RTC_periods = input_params(7);
RTC_hrs = input_params(8);
REC_Cost = input_params(9);
REC_wind = input_params(10);
REC_solar = input_params(11);
REC_hydro = input_params(12);
RenInOpCost = input_params(13);
EVSE = input_params(14);
EVSEfactor = input_params(15);
windyCurt = input_params(16);
solarCurt = input_params(17);
hydroCurt = input_params(18);
otherCurt = input_params(19);
windyCurtFactor = input_params(20);
solarCurtFactor = input_params(21);
hydroCurtFactor = input_params(22);
otherCurtFactor = input_params(23);
IncreasedDAMramp = input_params(24);
IncreasedRTCramp_Steam = input_params(25);
IncreasedRTDramp_Steam = input_params(26);
IncreasedRTCramp_CC = input_params(27);
IncreasedRTDramp_CC = input_params(28);
DAMrampFactor = input_params(29);
RTCrampFactor_Steam = input_params(30);
RTDrampFactor_Steam = input_params(31);
RTCrampFactor_CC = input_params(32);
IncreasedRTDramp_CC = input_params(33);
killNuke = input_params(34);
droppit = input_params(35);
printRTC = input_params(36);
Avg5mingencompare = input_params(37);
minrunshorter = input_params(38);
useinstant = input_params(39);
mustRun = input_params(40);
undrbidfac = input_params(41);
most_period_count = input_params(42);
